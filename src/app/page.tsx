      ...
      <div className="relative flex flex-col items-center justify-center bg-[#139847]" style={{ minHeight: "100dvh" }}>
        ...
        <div className="relative z-10 flex flex-col items-center px-8 w-full max-w-sm">
          ...
          <div className="mt-8 w-full space-y-3">
            {[
              { icon: "🏌️", text: "クラブ・アイテムをまとめて管理" },
              { icon: "📝", text: "練習記録をつけてスコアアップ" },
              { icon: "🤖", text: "AIコーチに練習メニューを相談" },
              { icon: "⛳", text: "全国のゴルフ場を検索・お気に入り" },
            ].map((f) => (
              <div key={f.text} className="flex items-center gap-3 rounded-lg bg-white/10 px-4 py-2.5">
          ...
          <button
            ...
            className="mt-8 flex h-12 w-full items-center justify-center gap-2.5 rounded-full bg-[#06C755] text-white font-bold text-base shadow-lg"
          >
