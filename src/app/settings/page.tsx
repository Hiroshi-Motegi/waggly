        ...
        <div className="relative z-10 flex flex-col space-y-2">
          ...
          <div className="rounded-lg bg-white p-4">
            ...
            <button
              ...
              className="flex h-11 w-full max-w-xs mx-auto items-center justify-center gap-2 rounded-full bg-[#006728] text-white text-base font-bold"
            >
            ...
            <button
              ...
              className="mt-2 flex h-11 w-full max-w-xs mx-auto items-center justify-center gap-2 rounded-full bg-[#06C755] text-white text-base font-bold"
            >
