  ...
  return (
    <div className="p-4 pb-24 space-y-6 text-sm">
      ...
      <section className="space-y-2">
        ...
        <p>本サービスでは、LINEアカウント情報（表示名・プロフィール画像）、登録されたクラブ情報、練習記録、AIとの会話履歴を保存します。これらの情報はサービス提供の目的のみに使用し、個人を特定できる形での第三者への提供は行いません。</p>
      </section>

      <section className="space-y-2">
        <h3 className="font-semibold">第4条（匿名データの活用）</h3>
        <p>本サービスでは、サービス品質の向上を目的として、ユーザーの登録データ（クラブスペック、練習記録、AI提案への評価等）を匿名化・統計化した上で、AI機能の改善に活用する場合があります。</p>
        <p>統計データには個人を特定できる情報は含まれません。活用例：</p>
      ...
      <section className="space-y-2">
        <h3 className="font-semibold">第5条（禁止事項）</h3>
        <p>以下の行為を禁止します。</p>
        <ul className="list-disc pl-5 space-y-1">
      ...
      <section className="space-y-2">
        <h3 className="font-semibold">第7条（サービスの変更・停止）</h3>
        <p>運営者は、事前の通知なくサービス内容の変更、または提供の停止を行うことがあります。</p>
      </section>

      <section className="space-y-2">
        <h3 className="font-semibold">第8条（規約の変更）</h3>
