...
export function BottomNav() {
  ...
  return (
    <div className={`fixed bottom-0 left-1/2 -translate-x-1/2 w-full z-50 px-2 ${isNative() ? "" : "max-w-screen-sm"}`} style={{ paddingBottom: "calc(var(--bottom-nav-padding) + env(safe-area-inset-bottom))" }}>
