    ...
    <div className="flex-1 flex flex-col items-center text-center px-6">
      <div className="flex flex-col items-center justify-center pt-10 pb-4">
        <img
          ...
          className="mb-4"
        />
        <h2 className="text-xl font-bold text-white leading-snug mb-6">
          ゴルファーのための
          <br />
          ギア & 練習管理アプリ
        </h2>
...
function Slide2() {
  return (
    <div className="flex-1 flex flex-col items-center text-center overflow-y-auto px-4 pt-4 pb-8">
      <h2 className="text-xl font-bold text-white leading-snug my-6">
        ギアをまとめて管理
        <br />
        仲間にかんたんシェア
      </h2>
      ...
      {/* Callout 1 */}
      <div className="w-full bg-white/90 rounded p-3 mb-4">
      ...
      {/* Callout 2 */}
      <div className="w-full bg-white/90 rounded p-3">
        <p className="text-base font-bold text-[#2c2c2c] text-center leading-snug">
...
function Slide3() {
  return (
    <div className="flex-1 flex flex-col items-center text-center overflow-y-auto px-4 pt-4 pb-8">
      ...
      {/* Callout */}
      <div className="w-full bg-white/90 rounded p-3 mt-2">
        <p className="text-base font-bold text-[#2c2c2c] text-center leading-snug">
          練習結果を元に
          <br />
          AIに練習メニューの相談ができます
      ...
      {/* Notes */}
      <ul className="w-full text-left px-1 py-3 text-xs font-bold text-white/80 leading-relaxed list-disc pl-5 space-y-2">
