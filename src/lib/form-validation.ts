...
export const clubValidationSchema: ValidationSchema = {
  ...
  grip_name: { maxLength: { value: 50, message: "50文字以内で入力してください" } },
  bounce: { range: { min: 0, max: 30, message: "0〜30の範囲で入力してください" } },
  face_angle: { range: { min: -5, max: 5, message: "-5〜5の範囲で入力してください" } },
  shaft_weight: { range: { min: 0, max: 200, message: "0〜200の範囲で入力してください" } },
